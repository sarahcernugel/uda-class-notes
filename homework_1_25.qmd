...
glob.glob("/Users/sarahcernugel/uda-class-notes/calls/*")

q1_23_df = pd.read_table('/Users/sarahcernugel/uda-class-notes/calls/wwe_q1_2023.txt')
q3_24_df = pd.read_table('/Users/sarahcernugel/uda-class-notes/calls/tko_q3_2024.txt')
q3_23_df = pd.read_table('/Users/sarahcernugel/uda-class-notes/calls/edr_q3_2023.txt')
q2_23_df = pd.read_table('/Users/sarahcernugel/uda-class-notes/calls/wwe_q2_2023.txt')

wwe_calls = pd.DataFrame(data, columns=['ticker', 'quarter', 'year'])
...
```{python}
# API Key WPP4DPSKZ7JJRC9L
import requests 
import plotly.express as px 

url = 'https://www.alphavantage.co/query?function=TIME_SERIES_DAILY&symbol=IBM&apikey=WPP4DPSKZ7JJRC9L'
r = requests.get(url)
data = r.json()
...
fig = px.line(data, x="species", y="petal_width") 
